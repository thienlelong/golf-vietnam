    ...
    function column_default($item, $column_name){
        switch($column_name){
           /* case 'ID':*/
            ...
            case 'dates':
            case 'competitor':
            case 'competitor_dates':
            case 'competitor_name':
            case 'competitor_signature':
            case 'receipt_waiver':
            case 'receipt_dates':
            case 'receipt_name':
   ...
   function column_title($item){
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'competitor_name'  => array('competitor_name',false),
            'competitor_signature'  => array('competitor_signature',false),
    ...
    function prepare_items() {
       ...
       /* $this->column_title($data);*/
        ...
        function usort_reorder($a,$b){
            $orderby = (!empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'location'; //If no sort, default to title
...
function tt_add_menu_items(){
    add_menu_page('List Waiver Form', 'List Waiver Form', 'activate_plugins', 'tt_list_test', 'tt_render_list_page', null, '3.1');
}
